  ...
  describe('ROUTES', () => {
    it('should generate routes without scope prefix when APP_API_SCOPE_PREFIX is empty', () => {
      ...
      jest.isolateModules(() => {
        ...
        expect(freshRoutes.BUILDINGS).toBe('buildings');
    ...
    it('should handle undefined APP_API_SCOPE_PREFIX', () => {
      ...
      jest.isolateModules(() => {
        ...
        expect(freshRoutes.HEALTH).toBe('data-enrich/health');
        expect(freshRoutes.BUILDINGS).toBe('data-enrich/buildings');
        expect(freshRoutes.DOCS).toBe('data-enrich/docs/swagger/ui');
      });
    });
    ...
    it('should handle complex scope prefix', () => {
      ...
      jest.isolateModules(() => {
        ...
        expect(freshRoutes.BUILDINGS).toBe('api/v1/template/buildings');
