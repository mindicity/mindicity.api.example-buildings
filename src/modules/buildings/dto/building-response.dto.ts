...
const BuildingResponseSchema = z.object({
  ...
  geometry: z.record(z.string(), z.any()).optional().describe('Building geometry in GeoJSON format'),
  basic_data: z.record(z.string(), z.any()).describe('Additional building data in JSON format'),
